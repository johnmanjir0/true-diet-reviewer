...
export default function Home({ defaultQuery = "" }: { defaultQuery?: string }) {
  ...
  return (
    <>
      ...
      <main className="container">
        <Breadcrumbs items={[
          { label: "ダイエット解析", href: defaultQuery ? "/diet" : undefined },
          ...(defaultQuery ? [{ label: defaultQuery }] : [])
        ]} />
        <div className="glass-panel" style={{ marginTop: "1rem" }}>
          <h1 className="title">Diet Reviewer</h1>
